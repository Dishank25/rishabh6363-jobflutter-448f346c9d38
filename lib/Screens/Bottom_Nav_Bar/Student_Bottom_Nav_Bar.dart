...
import 'package:job_portal/Screens/AI_Prediction_Screens/AI_Prediction_Screens.dart';
import 'package:job_portal/Screens/Job_Related_Screens/Feed_Screen.dart';
import 'package:job_portal/Screens/Job_Related_Screens/Feed_Screen_2.dart';
import 'package:job_portal/Screens/Job_Related_Screens/Job_Search_Screen.dart';
import 'package:job_portal/Screens/User_Profile_Screens/User_Profile_Screen__1.dart';
...
class _Student_Bottom_Nav_barState extends State<Student_Bottom_Nav_bar> {
 ...
 TextEditingController addFeedController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      extendBody: true,
      floatingActionButton: selected_index==0? Container(
        height: 44,
        width: 44,
            ...
            showModalBottomSheet(context: context,
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                          Text("New Post", style: mTextStyle32(),),
                      SizedBox(height: 10,),
                      Text("Add value to your feed. What’s worth sharing?",style: mTextStyle12(), ),
                      SizedBox(height: 16,),
                     Container(
                       height: 220,
                       width: 308,
                                             ...
                                             Container(
                                               ...
                                               child: Row(
                                                 ...
                                                 children: [
                                                   ...
                                                   Text("  Browse Files", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 9, color: Colors.white))
                                                 ],
                                               ),
                                             ),
                                             SizedBox(height: 15,),
                                             Text("Upload photos here",style: TextStyle(fontWeight: FontWeight.w500, fontSize: 9, color: Colors.grey.shade500) )
                                           ],
                                         ),
                                       ),
                                     ),
                      ...
                      SizedBox(
                        height: 36,
                          width: 308,
                          child: CustomTextField(controller: addFeedController, hintText:"Add Caption...", suffixIcon: Icons.send,
                            onSuffixTap: (){
                            setState(() {
