         ...
         child: Column(
           crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Text("Payment", style: mTextStyle32(mColor: Colors.black),),
              SizedBox(height: 20,),
               Text("Select Payment Method", style: mTextStyle12(),),
               SizedBox(height: 25,),
...
Widget paymentOptionContainer({required String text, required VoidCallback onTap}){
  return Container(
    height: 46,
      ...
      child: Row(
        children: [
          ...
          Padding(
            ...
            child: Text(text, style: mTextStyle14(),),
          ),
          Spacer(),
          Padding(
