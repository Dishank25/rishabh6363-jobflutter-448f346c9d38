          ...
          child: Column(
            ...
            children: [
              ...
              AppReceivedCard(
                ...
                onTap:()
                  { Navigator.push(context, MaterialPageRoute(builder: (context)=>Recruiter_View_Full_Application_screen()));
                  }
              ),
            ],
          ),
...
class AppReceivedCard extends StatelessWidget{
  ...
  AppReceivedCard({required this.applicantName, required this.Location, required this.total_exp, required this.appliedDate, required this.resumeMatch,
  required this.bgColor, required this.tColor, required this.onTap});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(applicantName, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
              const Spacer(),
              colorContainer(resumeMatch: resumeMatch, bgColor: bgColor, tColor: tColor)
            ],
          ),
          const SizedBox(height: 4),
          Text(Location, style: TextStyle(fontSize: 9, fontWeight: FontWeight.w400,),),
          const SizedBox(height: 2),
          Text("Total Work Experience: $total_exp",style: TextStyle(fontSize: 9, fontWeight: FontWeight.w400,),),
          const SizedBox(height: 8),
          Row(
            children: [
              Text("Applied $appliedDate days ago", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w400,),),
              const Spacer(),
              SizedBox(
                width: 160,
