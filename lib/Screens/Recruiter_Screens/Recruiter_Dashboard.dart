...
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_Analytics_Reports.dart';
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_Setting_Panel.dart';
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_Upcoming_Interviews.dart';
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_pending_tasks.dart';
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_pipeline_candidates.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("DashBoard", style: mTextStyle32(mColor: Colors.black),),
              SizedBox(height: 25,),
              ...
              DashBoardConatiner(
                  ...
                  notificationNum: "(3)",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterTotalJobPosts()));
                  }
              ),
              SizedBox(height: 20,),
              DashBoardConatiner(
                  ...
                  notificationNum: "(2)",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterPipelineCandidates()));
                  }
              ),
              SizedBox(height: 20,),
              DashBoardConatiner(
                  ...
                  notificationNum: "(3)",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterUpcomingInterviews()));
                  }
              ),
              SizedBox(height: 20,),
              DashBoardConatiner(
                  ...
                  notificationNum: "(5)",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterPendingTasks()));
                  }
              ),
              SizedBox(height: 20,),
              DashBoardConatiner(
                  ...
                  notificationNum: "",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterAnalyticsReports()));
                  }
              ),
              SizedBox(height: 20,),
              DashBoardConatiner(
                  ...
                  notificationNum: "",
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterSettingPanel()));
                  }
              ),
              SizedBox(height: 20,),
            ],
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(Heading, style: mTextStyle14(mFontWeight: FontWeight.w600),),
              Spacer(),
               InkWell(onTap:(){},child: Icon(Icons.more_horiz))
            ],
          ),
          SizedBox(height: 9,),
          Text(SubHeading, style: TextStyle(fontSize: 12, color: AppColors.blueTextColor, fontWeight: FontWeight.w400),),
          SizedBox(height: 12,),
          Container(
            height: 26,
            width: 150,
            ...
            child: InkWell(
              ...
              child: Row(
                ...
                children: [
                  Text(redButtonTitle,style:mTextStyle12(mColor:Colors.white ),),
                  SizedBox(width: 3,),
                  Text(notificationNum,style: mTextStyle12(mColor: Colors.white),)
                ],
              ),
            ),
          )
