    ...
    return Scaffold(
      ...
      body:  SingleChildScrollView(
        ...
        child: Column(
               ...
               children: [
                Text("Upcoming Interviews", style: mTextStyle32(mColor: Colors.black),),
                SizedBox(height: 25,),
                     Row(
                       children: [
                         Expanded(child: CustomTextField(controller: searController, hintText: "Search by name, role or keyword...", fillColor: Colors.white, suffixIcon: Icons.search, onSuffixTap: (){},)),
                           SizedBox(width: 10,),
                       InkWell(
                         onTap: (){},
                 ...
                 Row(
                   ...
                   crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     optionContainer(title: "Today", textColor:Color(0xff6C7278) , bgColor: Colors.white, nApplications: "(2)"),
                     optionContainer(title: "This Week", textColor:Color(0xff6C7278) , bgColor: Colors.white, nApplications: "(4)"),
                     optionContainer(title: "Custom", textColor:Color(0xff6C7278) , bgColor: Colors.white, nApplications: ""),
                   ],
                 ),
                 SizedBox(height: 20,),
                 InterviewCard(
...
class InterviewCard extends StatelessWidget{
  ...
  InterviewCard({required this.applicantName, required this.postName, required this.Mode, required this.interviewDate, required this.status,
    required this.bgColor, required this.tColor, required this.interviewTime, required this.viewContainerText});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(" $interviewDate  $interviewTime ", style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400,),),
              const Spacer(),
              SizedBox(
                width: 160,
