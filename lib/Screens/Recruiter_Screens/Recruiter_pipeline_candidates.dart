                        ...
                        SizedBox(height: 25,),
                         ...
                         Row(
                           ...
                           children: [
                             ...
                             optionContainer(title: "Screening", textColor: Color(0xff6C7278), bgColor: Colors.white, nApplications: "(4)"),
                             optionContainer(title: "Interview", textColor: Color(0xff6C7278), bgColor: Colors.white, nApplications: "(3)"),
                             optionContainer(title: "Offered", textColor: Color(0xff6C7278), bgColor:Colors.white,nApplications: "(1)"),
                         ...
                         Padding(
                           ...
                           child: optionContainer(title: "Hired", textColor: AppColors.blueTextColor, bgColor: Colors.blue.shade100, nApplications: "(2)"),
                         ),
                         SizedBox(height: 20,),
                         AppReceivedCard(applicantName: "Sonali Ahuja", postName: "UX Designer", total_exp: "Fresher", appliedDate: "3", status: "Actively Hiring", bgColor: Color(0xffFFF6E4), tColor: Color(0xffFFA30F)),
                         SizedBox(height: 20,),
                         AppReceivedCard(applicantName: "Shanaya Arora", postName: "UX Designer", total_exp: "3 years", appliedDate: "3", status: "Hired", bgColor: Color(0xffE0F8EB), tColor: Color(0xff00BC5E)),
...
class AppReceivedCard extends StatelessWidget{
 ...
 String status;
  ...
  AppReceivedCard({required this.applicantName, required this.postName, required this.total_exp, required this.appliedDate, required this.status,
    required this.bgColor, required this.tColor});
