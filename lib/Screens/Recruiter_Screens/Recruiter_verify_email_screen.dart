...
import 'package:job_portal/Screens/Post%20Internships%20Screens/Post%20Internships%20Screen.dart';
                ...
                children: [
                  ...
                  SizedBox(
                      ...
                      child: commonRedContainer(text: "Verify Email", onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>PostInternshipsScreen()));
                      })),
                  mSpacer(),
                  Center(
                    child: Row(
