      ...
      /// BODY
        ...
        padding: const EdgeInsets.only(right: 24.0,top: 7.0, left: 24.0),
                     child: Column(
                          ...
                          children: [
                          Text("Total Jobs Posted", style: mTextStyle32(mColor: Colors.black),),
                             SizedBox(height: 25,),
                             Row(
                              children: [
                              SizedBox(
                         ...
                         SizedBox(height: 25,),
                            TotalJobPostsCard(
                                ...
                                subHeading: "Last date to receive application is 27/04/2025.",
                                status: "Active",
                                nApplications: "(130)",
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text(heading, style: mTextStyle12(mFontWeight: FontWeight.w600)),
                const Spacer(),
            ...
            Row(
              children: [
                SizedBox(
                  ...
                  child: greyContainer(
                    text: status,
                    bgColor: isActive ? const Color(0xff1DB32F) : Colors.grey.shade500,
                  ),
                ),
                ...
                onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> RecruiterApplicationsScreen(postName: heading)));
                } ,)
              ],
            )
          ],
...
Widget numSeenContainer({required int nSeen}){
  return Container(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        SvgPicture.asset("assets/Icons/fi-rr-eye.svg", height: 12, width: 12,),
        SizedBox(width: 6,),
        Text(nSeen.toString(), style: TextStyle(fontSize: 11, color: AppColors.textSize12Color, fontWeight: FontWeight.w500),)
      ],
    ),
...
Widget customSearchBar({required TextEditingController controller, required String  hint}) {
  return Container(
