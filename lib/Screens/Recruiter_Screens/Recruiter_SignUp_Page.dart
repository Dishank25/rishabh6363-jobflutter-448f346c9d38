...
import 'package:job_portal/Screens/Recruiter_Screens/Recruiter_verify_email_screen.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    SizedBox(
                        ...
                        child: CustomTextField(
                            controller: recruiterNameController , hintText: "Aman", fillColor: Colors.white)),
                    Spacer(),
                    SizedBox(
                        width: 165,
                        child: CustomTextField(
                            controller: recruiter_SurNameController, hintText: "Gupta", fillColor: Colors.white)),
                  ],
                ),
                ...
                mSpacer(),
                commonRedContainer(text: "Register", onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruiterVerifyEmailScreen()));
                }),
                mSpacer(),
                Row(
                ...
                dividerLine(),
                mSpacer(),
                belowBars(text: "Continue with Google",
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                        ...
                        child: Text(" Login", style: mTextStyle12(
