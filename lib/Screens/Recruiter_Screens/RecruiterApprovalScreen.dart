    ...
    return Scaffold(
        ...
        padding: const EdgeInsets.only(right: 24.0,top: 7.0, left: 24.0),
              child: Column(
               ...
               children: [
                Text("Approvals", style: mTextStyle32(mColor: Colors.black),),
                SizedBox(height: 25,),
                  Row(
                   children: [
                  ...
                  SizedBox(height: 15,),
                   ...
                   mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                       optionContainer(title: "Pending", textColor:Color(0xff6C7278) , bgColor: Color(0xffFFF7FB), nApplications: "(1)"),
                        optionContainer(title: "Approved", textColor:Color(0xff6C7278) , bgColor: Color(0xffFFF7FB), nApplications: "(1)"),
                       optionContainer(title: "Rejected", textColor:Color(0xff6C7278) , bgColor:Color(0xffFFF7FB), nApplications: ""),
               ],
               ),
               SizedBox(height: 20,),
                 ApprovalCard(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              optionContainer(
                  title: status, textColor: getStatusTextColor(), bgColor: getStatusBgColor()),
