                 ...
                 // SizedBox(width: 10,),
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Digital Marketing Executive", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
                        Text("Uber", style: mTextStyle14(),),
                        SizedBox(height: 10,),
                        Row(
                          children: [
             ...
             SizedBox(height: 11,),
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        child: Text("More Job openings at Uber", style: mTextStyle14().copyWith(color: AppColors.blueTextColor,))),
                  SizedBox(height: 15,),
              ...
              InkWell(
                onTap: (){
                  ...
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Student_Bottom_Nav_bar()));
                },
...
Widget greyContainer({required String text, required Color bgColor }){
  final Color textColor = bgColor ==Color(0xffEFF0F6)? Color(0xff6C7278): Colors.white;
  return  Container(
    width: 100,
    decoration: BoxDecoration(
        color: bgColor,
    ...
    child: Padding(
      ...
      child: Center(child: Text(text, style: TextStyle(fontSize: 12, color: textColor),)),
    ),
  );
}
 ...
 Widget jobRelatedOptions({required String title}){
  return Container(
    ...
    child: Padding(
      padding: const EdgeInsets.symmetric(horizontal: 8.0),
      child: Center(child: Text(title, style: TextStyle(fontSize: 11, color: Color(0xff6C7278), fontWeight: FontWeight.w400))
        ,),
    ),);
 }
