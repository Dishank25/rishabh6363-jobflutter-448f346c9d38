                      ...
                      height: 56,
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(28),
                            child: Image.network("https://img.freepik.com/free-photo/portrait-white-man-isolated_53876-40306.jpg", fit: BoxFit.cover,))),
                 Spacer(),
                  SizedBox(
                    width: 270,
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        onTap: (){},
                          child: Text("Add Media", style: mTextStyle12(),))
                    ],
                  ),
                  SizedBox(height: 32,),
                  FeedCard(
                      imageUrl: "https://static-00.iconduck.com/assets.00/uber-icon-1024x1024-4icncyyo.png",
                      company: "Uber",
                      posted: "2 days",
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                           ...
                           SizedBox(width: 12,),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Rohan", style: mTextStyle14(),),
                                Text("Digital Marketer @Uber", style: mTextStyle12(),)
                              ],
                            ),
                              Spacer(),
                          ...
                          SizedBox(
                            width: 60,
                              child: greyContainer(text: "3 days", bgColor: Color(0xffEFF0F6))),
                          SizedBox(height: 10,),
                          Text("Hey! Just started a new project.Check the link in my profile and comment your suggestions. see more..."),
                          SizedBox(height: 20,),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              iconNamePair(imgUrl:"assets/Icons/All_the_best_icon.svg" , iconName:"Like"),
                             iconNamePair(imgUrl: "assets/Icons/messenger.svg", iconName: "Comment"),
                             iconNamePair(imgUrl: "assets/Icons/share_icon.svg", iconName: "Share"),
                             iconNamePair(imgUrl:"assets/Icons/send_icon.svg", iconName: "Send")
                            ],
                          )
                        ],
                      ),
