              ...
              children: [
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Job Filters", style: mTextStyle32(mColor: Colors.black),),
                      Text("Help us match you with the best career opportunities", style: mTextStyle12(),)
                    ],
                  ),
                ),
                SizedBox(height: 25,),
                Text("Profile", style:mTextStyle12() ,),
                SizedBox(height: 2,),
                CustomTextField(controller: profileController, hintText: "Eg.Marketing", suffixIcon: Icons.keyboard_arrow_down_outlined,fillColor: Colors.white,),
                SizedBox(height: 20,),
                Text("Location", style:mTextStyle12() ,),
                SizedBox(height: 2,),
                CustomTextField(controller: locationController, hintText: "Eg.Delhi", suffixIcon: Icons.keyboard_arrow_down_outlined,fillColor: Colors.white,),
               // SizedBox(height: 20,),
                Row(
                  children: [
                    ...
                    Text("Remote", style: mTextStyle12(),),
                    SizedBox(width: 20,),
                    ...
                    Text("Hybrid", style: mTextStyle12(),)
                  ],
                ),
                ...
                Row(
                  children: [
                    InkWell(
                      onTap: (){},
                        child: Text("Clear All", style:mTextStyle12(mFontWeight: FontWeight.w600, mColor: AppColors.blueTextColor ,),)),
                   Spacer(),
                    nextButton(title: "Apply", onTap: (){
