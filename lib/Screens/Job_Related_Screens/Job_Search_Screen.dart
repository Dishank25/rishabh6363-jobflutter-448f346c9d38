...
class _JobSearchScreenState extends State<JobSearchScreen> {
 ...
 List<Map<String, dynamic>> mList = [
   ...
   },
   {
     ...
     "company_name": "GitHub",
     "image": "https://seekvectors.com/files/download/e58196130297806acd58a2bf536ac0bc.jpg",
     "location": "Remote",
                         ...
                         mainAxisSize: MainAxisSize.min,
                          ...
                          Container(
                            ...
                            child: Column(
                             crossAxisAlignment: CrossAxisAlignment.start,
                             children: [
                               Text("Jobs", style: mTextStyle32(mColor: Colors.black),),
                               Text("Start applying to the latest job vacancies at the\nleading companies in India below.", style: mTextStyle14(mColor: Color(0xff6C7278)
                               )),
                               SizedBox(height: 25,),
                               Padding(
                                 ...
                                 child: ListView.builder(
                                   ...
                                   itemBuilder: (context, index) {
                                     ...
                                     return JobCard(
                                       onTap: (){
                                         setState(() {
                                           if(widget.onCallBackFromJobDetailsPage!=null){
...
class JobCard extends StatelessWidget {
  final String imageUrl, jobTitle, company, location, experience, salary, status, posted, match;
  VoidCallback onTap;
