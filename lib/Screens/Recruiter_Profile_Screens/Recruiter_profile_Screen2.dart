      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text("Anjali Sharma", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),),
            Text("AnjaliSharma@gmail.com", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w400)),
            SizedBox(height: 15,),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 3,),
                  Text("Lead Recruiter, Flipkart, Bangalore, India", style: mTextStyle12(mColor: Color(0xff9095A0),)),
                  SizedBox(height: 3,),
                  Row(
                    children: [
                  ...
                  SizedBox(height: 15,),
                  Text("Contact Information", style: mTextStyle12(mColor: Color(0xff544C4C)),),
                  SizedBox(height: 3,),
                  Text("+91XXXXXXXXX, email:", style: mTextStyle12(mColor: Color(0xff9095A0),)),
                  SizedBox(height: 3,),
                  Row(
                    children: [
                      InkWell( onTap:(){}, child: Text("View/", style: mTextStyle12(mColor: AppColors.blueTextColor),)),
