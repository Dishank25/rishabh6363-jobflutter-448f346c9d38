...
class RecruiterCreateQuickTicket extends StatefulWidget {
  ...
  @override
  State<RecruiterCreateQuickTicket> createState() => _RecruiterCreateQuickTicketState();
}
...
class _RecruiterCreateQuickTicketState extends State<RecruiterCreateQuickTicket> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Support", style: TextStyle(fontSize: 21, fontWeight: FontWeight.w600),)),
        actions: [
          Padding(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Create Quick Ticket", style: mTextStyle32(mColor: Colors.black),),
            SizedBox(height: 15,),
            Text("Write and address new queries and issues", style: mTextStyle12(),),
            SizedBox(height: 25,),
            ...
            SizedBox(height: 25,),
            Text("Ticket Body", style: mTextStyle12(),),
            SizedBox(height: 4,),
            CustomTextField(controller: ticketController, hintText:"Type your issue here...", fillColor: Color(0xffFFF7FB),),
            SizedBox(height: 25,),
