...
class RecruiterProfilescreen1 extends StatefulWidget {
  ...
  @override
  State<RecruiterProfilescreen1> createState() => _RecruiterProfilescreen1State();
}
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Anjali Sharma",style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white ),),
                            Text("AnjaliSharma@gmail.com", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.white ))
                          ],
                        ),
                      ),
                    ]
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      UserProfileEnteries(mIcon: "assets/Icons/application_icon.svg", title: "Activity Feed", desc: "Your recent activity",mArrow: Icons.keyboard_arrow_right_outlined,
                          onTap: (){
  ...
  return Row(
    children: [
      Container(
        ...
        child: SvgPicture.asset(mIcon, height: 20, width: 20,),
      ),
      SizedBox(width: 16,),
      Expanded(
        child: Column(
          ...
          children: [
            ...
            Text(desc ?? "",style: mTextStyle12(),)
          ],
        ),
      ),
      IconButton(onPressed: onTap, icon: Icon(mArrow), color: Colors.black,)
    ],
  );
}
