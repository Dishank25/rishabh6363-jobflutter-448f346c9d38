      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text("Aman Gupta", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),),
            Text("Aman@gmail.com", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w400)),
            SizedBox(height: 15,),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("About", style: mTextStyle12(mColor: Color(0xff544C4C)),),
                  SizedBox(height: 3,),
                  Text("Hi, I am Aman working as a designer from 3 years...", style: mTextStyle12(mColor: Color(0xff9095A0),)),
                  SizedBox(height: 3,),
                  Row(
                    children: [
                      InkWell( onTap:(){}, child: Text("View/", style: mTextStyle12(mColor: AppColors.blueTextColor),)),
                      InkWell( onTap:(){}, child: Text("Edit About",style: mTextStyle12(mColor: AppColors.blueTextColor))),
                    ],
                  ),
                  SizedBox(height: 15,),
                  Text("Career Objective", style: mTextStyle12(mColor: Color(0xff544C4C)),),
                  SizedBox(height: 3,),
                  Text("lorem ipsum", style: mTextStyle12(mColor: Color(0xff9095A0),)),
                  SizedBox(height: 3,),
                  Row(
                    children: [
                      InkWell( onTap:(){}, child: Text("View/", style: mTextStyle12(mColor: AppColors.blueTextColor),)),
                  ...
                  profileSection(
                    ...
                    onEditTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>UserSkillsApprovalScreen()));
                    },
                    editText: "Add Skills",
                  ),
                  ...
                  profileSection(
                    ...
                    onEditTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>UserExperienceApprovalScreen()));
                    },
                  ...
                  profileSection(
                    ...
                    onEditTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>UserEducationApprovalScreen()));
                    },
                  ...
                  profileSection(
                    ...
                    isGetVerified: true,  // Only show "Get Verified" without "Edit/"
                  ),
                ],
              ),
            ),
      ...
      Wrap(
        ...
        children: items.map((item) {
          return Row(
            ...
            children: [
              Icon(Icons.circle, color: item == items.first ? Colors.green : Colors.red, size: 6),
              SizedBox(width: 3),
        ...
        children: [
          ...
          if (!isGetVerified)
            InkWell(
              ...
              child: Text(
                editText,
                style: mTextStyle12(mColor: AppColors.blueTextColor, mFontWeight: FontWeight.w600),
              ),
            ),
        ],
      ),
