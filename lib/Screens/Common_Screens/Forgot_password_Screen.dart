...
import '../../Bloc State Management/Forget Password OTP API/Forget Password OTP Event.dart';
import '../../Bloc State Management/Forget Password OTP API/Forget Password OTP State.dart';

import '../../Bloc State Management/New Password API/New Password Bloc.dart';
import '../../Bloc State Management/New Password API/New Password Event.dart';
import '../../Bloc State Management/New Password API/New Password State.dart';
    ...
    appBar: buildCustomAppBar(titleText: "LOGO"),
      ...
      listeners: [
        BlocListener<ForgotPasswordBloc, ForgotPasswordState>(
          listener: (context, state) {
            ...
            if (state is ForgotPasswordSuccess) {
              ...
              final otp = _extractOtp(state.message);
              if (otp != null) {
                setState(() {
                  receivedOtp = otp;
                });
        ...
        BlocListener<ResetPasswordBloc, ResetPasswordState>(
          listener: (context, state) {
            print("ResetPasswordBloc State: $state");
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                  "Forgot Password", style: mTextStyle32(mColor: Colors.black)),
