...
class _SignInPageUniversityStudentState extends State<SignupAsAnyOne> {
  ...
  void initState() {
    ...
    // context.read<CollegeBloc>().add(FetchColleges());
    firstnameController.text = widget.basicUserInfoResponse.user.firstName;
    surnameController.text = widget.basicUserInfoResponse.user.lastName;
    emailController.text = widget.basicUserInfoResponse.user.email;
    phoneController.text = widget.basicUserInfoResponse.user.phone;
  }
  ...
  void didChangeDependencies() {
    ...
    // bloc.add(DetailedSignupGetColleges(emailMap));
