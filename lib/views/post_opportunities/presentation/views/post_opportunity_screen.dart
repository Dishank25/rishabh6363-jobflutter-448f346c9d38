...
// cityChoice: "Kanpur Nagar"
// collegeName: "Uiet Kanpur"
// course : "B.Com"
// daysInOffice: null
// incentivePerYear: "4-4 Month"
// internshipDuration: "6 month"
// internshipFromDate: null
// internshipStartDate: "Immediately"
// internshipToDate: null
// isCustomInternshipDate: false
// jobDescription: "njqe rjc ehr cjher her c"
// jobProfile : "Quality Assitence"
// jobTime: "Part-time"
// jobType : "In office"
// numberOfOpenings: 5
// opportunityType: "Internship"
// perks: "Certificate of completion, 5 days a week, Pre-placement offer (PPO)"
// phoneContact: null
// screeningQuestions: null
// skillRequiredNote: "React.js, Node.js, MongoDB, Express.js, JavaScript"
// skillsRequired: "Ai, poweBi ,Express"
// stipendMax: null
// stipendMin: null
// stipendType: "Unpaid"
            ...
            child: Column(
              ...
              children: [
                BlocListener<OpportunityBloc, OpportunityState>(
                  listener: (context, state) {
                    if (state is OpportunityMetadataLoaded) {
                      ...
                      developer.log(
                          "some error encountered while loading metadata.");
                    }
                  },
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: List.generate(internshipDayTimingsTypes.length,
                        (index) {
                      return Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 15.0),
                        child: Row(
